...
RSpec.describe Braille do
    ...
    it '2. can add a braille character to the grid' do
        braille.add_english(:h, './dummy_files/dummy_write.txt')
   ...
   it '3. can print braille characters in correct vertical and horizontal order' do
        ...
        braille.add_english(:h, './dummy_files/dummy_write.txt')
        braille.add_english(:e, './dummy_files/dummy_write.txt')
        braille.add_english(:l, './dummy_files/dummy_write.txt')
        braille.add_english(:l, './dummy_files/dummy_write.txt')
        braille.add_english(:o, './dummy_files/dummy_write.txt')
    ...
    it '4. will only allow 40 braille characters in a grid' do
        allow(braille).to receive(:print).and_return(double().as_null_object)
        41.times { braille.add_english(:a, './dummy_files/dummy_write.txt') }
    ...
    it '5. can write to file' do
        braille.add_english(:a, './dummy_files/dummy_write.txt')
        braille.add_english(:a, './dummy_files/dummy_write.txt')
        braille.add_english(:a, './dummy_files/dummy_write.txt')
        braille.add_english(:a, './dummy_files/dummy_write.txt')
        braille.add_english(:a, './dummy_files/dummy_write.txt')
